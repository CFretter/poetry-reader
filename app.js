...
var facts = [[`	"— Так багато на світі горя, <br>люди, будьте взаємно красивими! 
"	<br>	Ліна Костенко	`,`	The author Lina Kostenko encourages people to be mutually respectful as there is already too much grief in this world	`,`	— Tak bahato na sviti horia, <br>liudy, budte vzaiemno krasyvymy! 	`],
...
[`	Візьми лише найважливіше. Візьми листи. <br>Візьми лише те, що зможеш сама нести.	<br>	Сергій Жадан 	`,`	The author Serhii Zhadan  encourages to take only the most important stuff, the letters for example, but only what one carry on their own	`,`	Vizmy lyshe naivazhlyvishe. Vizmy lysty. <br>Vizmy lyshe te, shcho zmozhesh sama nesty.	`],
...
"	<br>	Юрій Іздрик 	`,`	The author Yurii Izdryk  says that seconds do not have measurement other than heart beats	`,`	sekundy ne maiut vymiru –<br>tse tilky udary sertsia	`],
...
"	<br>	Юрій Іздрик 	`,`	The author Yurii Izdryk  says that seconds do not have a choice, they just pass	`,`	sekundy ne maiut vyboru<br>sekundy – vony mynaiut 	`],
[`	"ми й в сутінках світу<br>де поспіхом навхрест прострочено мить<br>знайдемо свою павутинку зі світла
"	<br>	Юрій Іздрик 	`,`	The author Yurii Izdryk  believes that in the twilight of the world where the moment is briefly cross-stiched, people will find a web of light	`,`	my y v sutinkakh svitu<br>de pospikhom navkhrest prostrocheno myt<br>znaidemo svoiu pavutynku zi svitla	`],
[`	"Ламана лінія кордону, мов соснова гілка.<br>Дорога важка, коли несеш на спині свій дім і своє минуле. 
"	<br>	Сергій Жадан 	`,`	The author Serhii Zhadan  compares a borderline to a broken pine branch, confirming that the road is tough when one carries home and the past on the shoulders	`,`	Lamana liniia kordonu, mov sosnova hilka.<br>Doroha vazhka, koly nesesh na spyni svii dim i svoie mynule.	`],
[`	"Завжди пам’ятати розташування меблів у батьківському домі.<br>Ховати в кишені ключі, як засушену квітку. 
"	<br>	Сергій Жадан 	`,`	The author Serhii Zhadan  promises to always remember the furniture layout in the parents house and hide the key in the pocket like a dried flower	`,`	Zavzhdy pamiataty roztashuvannia mebliv u batkivskomu domi.<br>Khovaty v kysheni kliuchi, yak zasushenu kvitku. 	`],
...
"	<br>	Катерина Бабкіна 	`,`	The author Kateryna Babkina  wonders how it all happens here and now, although there is no time, no place, no dimension or sphere for this	`,`	Bo dlia takoho nemaie ni chasu, ni mistsia, ani vymiriv, ani sfer –<br>ale vse tse vse odno vidbuvaietsia prosto tut i teper	`],
...
"	<br>	Катерина Бабкіна 	`,`	The author Kateryna Babkina  believes that only love can heal the edges of the wound and revive the rivers and the springs	`,`	I vse, shcho pislia takoho mozhe ztsilyty – to khiba liubov.<br>Liubov zmozhe stulyty dokupy rozchakhnuti ran krai,<br>zmozhe zhyvyty soboiu potuzhni riky ta ruchai,	`],
